...
class UserController extends Controller {
	...
	public function actionCreate() {
		...
		if(isset($_POST['User']))
		{
			...
			/**
			 * Talvez fosse interessante verificar se já existe um outros
			 * username já criado no database
			 */
			if($model->save())
	...
	public function loadModel() {
		...
		{
			if(isset($_GET['name']))
				$this->_model=User::model()->findByAttributes(array('username'=>$_GET['name']));
